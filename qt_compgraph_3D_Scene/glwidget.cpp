...
{
    this->cubemodel =  new CubeModel(vector3(0,1,0),vector3(-3.0,-0.5,-1),vector3(1,1,1),0,1.0);
    this->spheremodel =  new SphereModel(vector3(1,0,0),vector3(0,-3.0,1.0),vector3(1,1,1),0,0.7);
    this->conemodel = new ConeModel(vector3(1,0,0),vector3(-1.6,-3.0,-0.3),vector3(1,1,1));
    this->pyramidmodel = new PyramidModel(vector3(1,0,0),vector3(1.2,-4.4,-0.2),vector3(1,1,1));
...
void GLWidget::Draw_cone(ConeModel* objectmodel,vector<int> color){
    glPushMatrix();
    glRotatef(objectmodel->angle,objectmodel->rotate.x,objectmodel->rotate.y,objectmodel->rotate.z);
    glTranslatef(objectmodel->shift.x,objectmodel->shift.y,objectmodel->shift.z);
    glScalef(objectmodel->scale.x,objectmodel->scale.y,objectmodel->scale.z);
...
void GLWidget::Draw_pyramid(PyramidModel* objectmodel,vector<int> color){
    glPushMatrix();
    glRotatef(objectmodel->angle,objectmodel->rotate.x,objectmodel->rotate.y,objectmodel->rotate.z);
    glTranslatef(objectmodel->shift.x,objectmodel->shift.y,objectmodel->shift.z);
    glScalef(objectmodel->scale.x,objectmodel->scale.y,objectmodel->scale.z);
...
void GLWidget::drawModels(){
   ...
   // Draw_spline(splinemodel_4,color);
    Draw_cone(conemodel,color);
    Draw_sphere(spheremodel,color);
    Draw_pyramid(pyramidmodel,color);
    color = {255,255,255};
